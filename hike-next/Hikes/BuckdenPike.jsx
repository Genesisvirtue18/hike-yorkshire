...
// import BuckdenPikeImage2 from "../../src/assets/WhyChoose/Buckden-Pike-2.webp";
...
export default function BuckdenPike() {
...
// Buckden Pike images (both versions - note spelling difference)
const BukdenPike = "/assets/DayHikes/bukden-pike.webp";
const BuckdenPikeImage2 = "/assets/WhyChoose/Buckden-Pike-2.webp";
  ...
  return (
    <section className="font-['Nunito_Sans'] text-gray-800">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(76.04deg, rgba(0, 0, 0, 0.4) 0.56%, rgba(102, 102, 102, 0) 43.21%), url(${BukdenPike})`,
        }}
      >
        <div className="absolute inset-0 bg-black/50 flex flex-col justify-end items-start px-4 sm:px-10 md:px-16 pb-6 md:pb-10 space-y-8 sm:space-y-10">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6 text-white text-sm sm:text-base">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm sm:text-base">
                <span className="font-semibold">Duration:</span> 3.5 hours
              </span>
            </div>
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-10 md:px-16">
        ...
        <div className="mt-8 mb-16">
          ...
          <h2 className="font-['Nunito_Sans'] font-semibold text-[20px] md:text-[22px] leading-[30px] md:leading-[32px] text-[#C56441] tracking-[0] mb-6">
            Climb one of the Yorkshire Dales' most distinctive peaks on this rewarding circular hike from Buckden village.
          </h2>

          {/* Paragraph 1 */}
          <p className="font-['Nunito_Sans'] font-normal text-[14px] md:text-[16px] leading-[32px] text-[#434343] mb-8">
            The Buckden Pike walk combines steep ascents, open moorland and dramatic views across Upper Wharfedale and Langstrothdale. Along the route, walkers encounter the Buckden Pike War Memorial, a poignant tribute to a WWII aircrew who crashed on the fell, and pass through rugged upland terrain alive with curlews, grouse, and wildflowers.
          </p>

          {/* Paragraph 2 */}
          <p className="font-['Nunito_Sans'] font-normal text-[14px] md:text-[16px] leading-[32px] text-[#434343] mb-12">
            The descent offers sweeping panoramas over the Dales and the River Wharfe far below. With a mix of stone paths and peat moor, this route offers both challenge and solitude, a true Dales experience for walkers. Guided options include insights into local geology, wildlife and wartime history.
          </p>

          {/* Map */}
          <div className="flex justify-center">
           <iframe className="alltrails" src="https://www.alltrails.com/widget/trail/england/north-yorkshire/buckden-circular?u=m&sh=6sspau" width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="AllTrails: Trail Guides and Maps for Hiking, Camping, and Running"></iframe>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <ul className="space-y-2 font-['Nunito_Sans'] text-[16px] leading-[28px] list-disc pl-6 marker:text-[#C56441]">
              <li>
                <span className="font-bold text-[#9B3F1E]">Buckden Pike Summit</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– the highest point at 702m with panoramic views over Upper Wharfedale
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Buckden Pike War Memorial</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– a poignant stone cross commemorating a WWII Polish aircrew who crashed on the fell
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Upper Wharfedale Views</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– sweeping vistas over the winding River Wharfe and surrounding dale villages
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Langstrothdale Panorama</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– breathtaking views north into the tranquil valley of Langstrothdale
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Buckden Village</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– a picturesque Dales village and traditional starting point for the walk
                </span>
              </li>
            </ul>
          </div>
...
>
  ...
  <div className="relative z-10 grid grid-cols-1 md:grid-cols-[45%_55%] gap-8 items-center">
    ...
    <div className="relative flex justify-center md:justify-start h-[260px] md:h-[360px]">
      ...
      <img
        src={BuckdenPikeImage2}
        alt="Buckden Pike summit view"
        className="
          w-[220px] h-[240px]
    ...
    <div className="text-center md:text-left">
      <h2
        ...
        "
      >
        Why Choose Buckden Pike?
      </h2>

      <ul className="space-y-4 text-[15px] md:text-[18px] text-[#C56441] font-medium">
        <li className="flex gap-3 items-start">
          <img src={icon1} className="w-6 h-6 object-contain" alt="Views" />
          <span className="font-['Nunito_Sans'] font-semibold leading-[26px]">
            One of the Dales’ most distinctive peaks offering stunning panoramic views across Upper Wharfedale and Langstrothdale
          </span>
        </li>
        ...
        <li className="flex gap-3 items-start">
          ...
          <span className="font-['Nunito_Sans'] font-semibold leading-[26px]">
            A route rich in history, featuring the poignant WWII memorial and insights into local wartime heritage
          </span>
        </li>
        ...
        <li className="flex gap-3 items-start">
          ...
          <span className="font-['Nunito_Sans'] font-semibold leading-[26px]">
            Experience true Dales solitude with abundant wildlife including curlews, grouse, and wildflowers in rugged upland terrain
          </span>
        </li>
      </ul>
    </div>
