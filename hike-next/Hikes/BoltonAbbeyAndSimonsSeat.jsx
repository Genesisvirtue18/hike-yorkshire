...
// import BoltonAbbeyImage2 from "../assets/WhyChoose/Bolton-Abbey-2.webp";
...
export default function BoltonAbbey() {
...
// Secondary images
const BoltonAbbeyImage2 = "/assets/WhyChoose/Bolton-Abbey-2.webp";
  ...
  return (
    <section className="font-['Nunito_Sans'] text-gray-800">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(76.04deg, rgba(0, 0, 0, 0.4) 0.56%, rgba(102, 102, 102, 0) 43.21%), url(${BoltonAbbeyImage})`,
        }}
      >
        <div className="absolute inset-0 bg-black/50 flex flex-col justify-end items-start px-4 sm:px-10 md:px-16 pb-6 md:pb-10 space-y-8 sm:space-y-10">
          ...
          <div className="space-y-1 sm:space-y-2">
            ...
            <p className="text-white text-[12px] sm:text-[14px] md:text-[18px] max-w-full sm:max-w-[650px] leading-[150%]">
              Experience the beauty of Bolton Abbey and Simon's Seat - a rewarding hike of rivers, woods, and panoramic Yorkshire views.
            </p>
          </div>
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-10 md:px-16">
        ...
        <div className="mt-8 mb-16">
          ...
          <p className="font-['Nunito_Sans'] font-normal text-[14px] md:text-[16px] leading-[32px] text-[#434343] mb-8">
            This Bolton Abbey and Simon's Seat hike combines riverside paths, woodland trails, and hilltop vistas for a memorable Yorkshire day out. Starting from the historic Bolton Abbey estate, the route follows the winding River Wharfe, passing charming bridges and waterfalls before ascending to Simon's Seat, a dramatic gritstone outcrop offering sweeping views of Wharfedale.
          </p>
          ...
          <div className="flex justify-center">
           <iframe className="alltrails" src="https://www.alltrails.com/widget/trail/england/north-yorkshire/bolton-abbey-and-simon-s-seat-circular?u=m&sh=6sspau" width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="AllTrails: Trail Guides and Maps for Hiking, Camping, and Running"></iframe>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <ul className="space-y-2 font-['Nunito_Sans'] text-[16px] leading-[28px] list-disc pl-6 marker:text-[#C56441]">
              <li>
                <span className="font-bold text-[#9B3F1E]">Bolton Abbey Ruins</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– atmospheric remains of a 12th-century priory beside the River Wharfe
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">River Wharfe Stepping Stones</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– a famous crossing offering a classic Yorkshire Dales experience
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Strid Wood</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– ancient woodland following the dramatic narrowing of the river
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Simon's Seat</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– a prominent gritstone outcrop with sweeping views over Wharfedale
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Wharfedale Moorland</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– open heather moors providing a sense of space and quiet above the valley
                </span>
              </li>
            </ul>
          </div>
...
>
  ...
  <div className="relative z-10 grid grid-cols-1 md:grid-cols-[45%_55%] gap-8 items-center">
    ...
    <div className="relative flex justify-center md:justify-start h-[260px] md:h-[360px]">
      ...
      <img
        src={BoltonAbbeyImage}
        alt="Simon's Seat view"
        className="
          hidden md:block
          w-[230px] h-[320px]
          object-cover
    ...
    <div className="text-center md:text-left">
      <h2
        ...
        "
      >
        Why Choose Bolton Abbey & Simon&apos;s Seat?
      </h2>

      <ul className="space-y-4 text-[15px] md:text-[18px] text-[#C56441] font-medium">
        <li className="flex gap-3 items-start">
          <img src={icon1} className="w-6 h-6 object-contain" alt="Heritage" />
          <span className="font-['Nunito_Sans'] font-semibold leading-[26px]">
            A classic Yorkshire walk combining historic abbey ruins with open moorland scenery
          </span>
        </li>

        <li className="flex gap-3 items-start">
          <img src={icon2} className="w-6 h-6 object-contain" alt="Views" />
          <span className="font-['Nunito_Sans'] font-semibold leading-[26px]">
            Steady climbs lead to wide-ranging views across Wharfedale and the surrounding countryside
          </span>
        </li>

        <li className="flex gap-3 items-start">
          <img src={icon3} className="w-6 h-6 object-contain" alt="Balanced" />
          <span className="font-['Nunito_Sans'] font-semibold leading-[26px]">
            An ideal intermediate route offering a satisfying challenge without being overly technical
          </span>
        </li>
      </ul>
    </div>
