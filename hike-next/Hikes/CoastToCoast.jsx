...
// import coastIllustration from "../../src/assets/DayHikes/coastIllustration.webp";
...
const coastIllustration = "/assets/DayHikes/coastIllustration.webp";
    ...
    return (
        <section className="font-['Nunito_Sans'] text-gray-800">
            ...
            <div
                ...
                style={{
                    backgroundImage: `linear-gradient(76.04deg, rgba(0, 0, 0, 0.4) 0.56%, rgba(102, 102, 102, 0) 43.21%), url(${coasttocoastmultiDayHikeImg})`,
                }}
            >
                <div className="absolute inset-0 bg-black/50 flex flex-col justify-end items-start px-4 sm:px-10 md:px-16 pb-6 md:pb-10 space-y-8 sm:space-y-10">
                    ...
                    <div className="flex flex-wrap gap-4 sm:gap-6 text-white text-sm sm:text-base">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm sm:text-base">
                                <span className="font-semibold">Duration:</span> Three 5 day sections 
                            </span>
                        </div>
            ...
            <div className="max-w-[1200px] mx-auto px-4 sm:px-10 md:px-16">
                ...
                <div className="mt-8 mb-16">
                    ...
                    <h2 className="font-['Nunito_Sans'] font-semibold text-[20px] md:text-[22px] leading-[30px] md:leading-[32px] text-[#C56441] tracking-[0] mb-6">
                        Designed by legendary fell-walker Alfred Wainwright, this iconic route crosses England from the Irish Sea to the North Sea.
                    </h2>
                    ...
                    <div className="flex justify-center">
                       <iframe className="alltrails" src="https://www.alltrails.com/widget/trail/england/cumbria/coast-to-coast-st-bees-to-robin-hood-s-bay?u=m&sh=6sspau" width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="AllTrails: Trail Guides and Maps for Hiking, Camping, and Running"></iframe>
  ...
  <div className="relative z-10 grid grid-cols-1 md:grid-cols-[45%_55%] gap-8 items-center">
    ...
    <div className="text-center md:text-left">
      <h2
        ...
        leading-tight mb-6"
      >
        Why Choose the Coast to Coast?
      </h2>

      <ul className="space-y-4 text-[15px] md:text-[18px] text-[#C56441] font-medium">
        <li className="flex gap-3 items-start">
          <img src={icon1} className="w-6 h-6 object-contain" alt="Legendary" />
          <span className="font-['Nunito_Sans'] font-semibold">
            One of the world’s greatest long-distance walks
          </span>
        </li>

        <li className="flex gap-3 items-start">
          <img src={icon2} className="w-6 h-6 object-contain" alt="Parks" />
          <span className="font-['Nunito_Sans'] font-semibold">
            Crosses three national parks and links two coasts
          </span>
        </li>

        <li className="flex gap-3 items-start">
          <img src={icon3} className="w-6 h-6 object-contain" alt="Flexible" />
          <span className="font-['Nunito_Sans'] font-semibold">
            Achievable through flexible, guided sections
          </span>
        </li>

        <li className="flex gap-3 items-start">
          <img src={icon4} className="w-6 h-6 object-contain" alt="Immersive" />
          <span className="font-['Nunito_Sans'] font-semibold">
