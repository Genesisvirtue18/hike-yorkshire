...
// import Ingleton2 from "../../src/assets/WhyChoose/Ingleton2.webp";
...
// Ingleton images (main and secondary)
const Ingleton = "/assets/DayHikes/Ingleton2.webp";
const Ingleton2 = "/assets/WhyChoose/Ingleton2.webp";
  ...
  return (
    <section className="font-['Nunito_Sans'] text-gray-800">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(76.04deg, rgba(0, 0, 0, 0.4) 0.56%, rgba(102, 102, 102, 0) 43.21%), url(${Ingleton})`,
        }}
      >
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6 text-white text-sm sm:text-base">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm sm:text-base">
                <span className="font-semibold">Length:</span> 4 miles
              </span>
            </div>
    ...
    "
        ...
        <div className="mt-8 mb-16">
          ...
          <h2 className="font-['Nunito_Sans'] font-semibold text-[20px] md:text-[22px] leading-[30px] md:leading-[32px] text-[#C56441] tracking-[0] mb-6">
            Explore the dramatic waterfalls and limestone landscapes of{" "}
            <span className="font-bold">Ingleton Falls</span> and the{" "}
            <span className="font-bold">Kingsdale Valley</span>.
          </h2>

          {/* Paragraph 1 */}
          <p className="font-['Nunito_Sans'] font-normal text-[14px] md:text-[16px] leading-[32px] text-[#434343] mb-8">
            This varied day hike takes you through one of the Yorkshire Dales’ most
            spectacular natural settings, combining tumbling waterfalls, narrow limestone
            gorges, and the wide open glacial valley of Kingsdale. Starting from the village
            of Ingleton, the route follows sections of the famous Ingleton Waterfalls Trail
            before branching out into quieter countryside beneath the slopes of Ingleborough.
          </p>

          {/* Paragraph 2 */}
          <p className="font-['Nunito_Sans'] font-normal text-[14px] md:text-[16px] leading-[32px] text-[#434343] mb-8">
            The walk passes through ancient woodland, alongside fast-flowing rivers, and
            across open pasture with far-reaching views of the surrounding peaks. Stone paths
            and footbridges make the gorge sections accessible, while the later stages offer
            a sense of space and remoteness typical of the high Dales.
          </p>

          {/* Paragraph 3 */}
          <p className="font-['Nunito_Sans'] font-normal text-[14px] md:text-[16px] leading-[32px] text-[#434343] mb-12">
            Guided walks focus on Ice Age geology, water power, and how rivers shaped early
            industry, farming, and settlement in this part of Yorkshire. With some stepped
            paths and steady climbs, the terrain is well defined and consistently rewarding,
            making this an ideal route for walkers seeking a classic Dales experience with
            depth and variety.
          </p>

          {/* Map */}
          <div className="flex justify-center">
          <iframe className="alltrails" src="https://www.alltrails.com/widget/trail/england/north-yorkshire/ingleton-waterfalls-circular?u=m&sh=6sspau" width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="AllTrails: Trail Guides and Maps for Hiking, Camping, and Running"></iframe>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <ul className="space-y-2 font-['Nunito_Sans'] text-[16px] leading-[28px] list-disc pl-6 marker:text-[#C56441]">
              <li>
                <span className="font-bold text-[#9B3F1E]">Thornton Force</span>
                <span className="text-[#363535] font-semibold">
                  {" "}–  A powerful waterfall dropping over a visible geological boundary between limestone and sandstone, clearly showing how the landscape was formed.

                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Pecca Falls</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– A series of elegant cascades linked by stone steps and bridges within a wooded gorge.

                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">River Doe & River Twiss Gorges</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– Deep, narrow valleys carved by glacial meltwater, rich in mosses, ferns, and woodland wildlife.
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Kingsdale Valley</span>
                <span className="text-[#363535] font-semibold">
                  {" "}–  A broad U shaped glacial valley offering expansive views towards Ingleborough and Whernside.

                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Limestone Pavements & Pasture</span>
                <span className="text-[#363535] font-semibold">
                  {" "}–  Classic Dales scenery featuring dry stone walls, grazing sheep, and exposed limestone shaped by thousands of years of weathering.
                </span>
              </li>
            </ul>
          </div>
        ...
        leading-tight mb-6"
            ...
            <ul className="space-y-4 text-[15px] md:text-[18px] text-[#C56441] font-medium">
              <li className="flex gap-3 items-start">
                <img src={icon1} className="w-6 h-6" alt="Waterfalls" />
                <span className="font-['Nunito_Sans'] font-semibold">
                  A spectacular route featuring powerful waterfalls, limestone gorges, and stone footbridges
                </span>
              </li>
              ...
              <li className="flex gap-3 items-start">
                ...
                <span className="font-['Nunito_Sans'] font-semibold">
                  Varied scenery combining ancient woodland, fast-flowing rivers, and open glacial valleys
                </span>
              </li>

              <li className="flex gap-3 items-start">
                <img src={icon3} className="w-6 h-6" alt="Geology" />
                <span className="font-['Nunito_Sans'] font-semibold">
                  A walk rich in Ice Age geology, water power history, and classic Yorkshire Dales landscapes
                </span>
              </li>
            </ul>
          </div>
