...
// import Yorkshire3peaksImage2 from "../../src/assets/Hero/hero-image.webp";
...
export default function YorkshireThreePeaks() {
  ...
  // Image constants as direct paths
...
const Yorkshire3peaksImage2 = "/assets/Hero/hero-image.webp";
  ...
  return (
    <section className="font-['Nunito_Sans'] text-gray-800">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(76.04deg, rgba(0, 0, 0, 0.4) 0.56%, rgba(102, 102, 102, 0) 43.21%), url(${Yorkshire3peaksImage})`,
        }}
      >
    ...
    "
        ...
        <div className="mt-8 mb-16">
          ...
          <h2 className="font-['Nunito_Sans'] font-semibold text-[20px] md:text-[22px] leading-[30px] md:leading-[32px] text-[#C56441] tracking-[0] mb-6">
            ...
            landscapes of <span className="font-bold">Pen-y-ghent</span>,{" "}
            <span className="font-bold">Whernside</span>, and{" "}
            <span className="font-bold">Ingleborough</span>.
          </h2>

          {/* Paragraph 1 */}
          <p className="font-['Nunito_Sans'] font-normal text-[14px] md:text-[16px] leading-[32px] text-[#434343] mb-8">
            This 25-mile trek is not for the faint-hearted. It is a full-day adventure
            featuring steep ascents, rugged terrain, and breathtaking views across the Dales.
            Hikers will router.push limestone pavements, rolling valleys, and dramatic ridges,
            testing both endurance and stamina along the way. The route also takes in iconic
            landmarks such as the Ribblehead Viaduct and traditional Dales villages.
          </p>

          {/* Paragraph 2 */}
          <p className="font-['Nunito_Sans'] font-normal text-[14px] md:text-[16px] leading-[32px] text-[#434343] mb-12">
            Perfect for experienced walkers seeking a true challenge, this route combines
            natural beauty with the satisfaction of completing one of the UK's most famous
            walking circuits. Guided groups help maintain a steady pace while ensuring safety
            and sharing insights into local history, geology, and wildlife. This experience
            offers a genuine immersion in the heart of the Yorkshire Dales.
          </p>

          {/* Map */}
          <div className="flex justify-center">
          <iframe className="alltrails" src="https://www.alltrails.com/en-gb/widget/trail/england/north-yorkshire/yorkshire-three-peaks-circular?u=m&sh=zdgnlz" width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" title="AllTrails: Trail Guides and Maps for Hiking, Camping, and Running"></iframe>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <ul className="space-y-2 font-['Nunito_Sans'] text-[16px] leading-[28px] list-disc pl-6 marker:text-[#C56441]">
              <li>
                <span className="font-bold text-[#9B3F1E]">Pen-y-ghent</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– a steep-sided peak known for its limestone steps and dramatic escarpments
                </span>
              </li>
              ...
              <li>
                ...
                <span className="text-[#363535] font-semibold">
                  {" "}– an iconic Victorian railway structure set in open moorland
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Whernside</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– the longest ascent of the challenge, offering wide panoramic views
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Ingleborough</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– a broad summit plateau with views across the Dales and beyond
                </span>
              </li>

              <li>
                <span className="font-bold text-[#9B3F1E]">Chapel-le-Dale</span>
                <span className="text-[#363535] font-semibold">
                  {" "}– a traditional Dales hamlet passed through during the route
                </span>
              </li>
            </ul>
          </div>
      ...
      >
        ...
        "
          ...
          <div className="text-center md:text-left">
            <h2 className="font-[Raleway] font-semibold italic text-[#4B4B4B]
        text-[22px] sm:text-[26px] md:text-[32px] lg:text-[36px]
        leading-tight mb-6">
              Why Choose the Yorkshire 3 Peaks?
            </h2>

            <ul className="space-y-4 text-[15px] md:text-[18px] text-[#C56441] font-medium">
              <li className="flex gap-3 items-start">
                <img src={icon1} className="w-6 h-6" alt="Challenge" />
                <span className="font-['Nunito_Sans'] font-semibold">
                  A legendary endurance challenge covering three iconic peaks in a single day
                </span>
              </li>

              <li className="flex gap-3 items-start">
                <img src={icon2} className="w-6 h-6" alt="Views" />
                <span className="font-['Nunito_Sans'] font-semibold">
                  Diverse terrain with sweeping views and dramatic ascents
                </span>
              </li>
              ...
              <li className="flex gap-3 items-start">
                ...
                <span className="font-['Nunito_Sans'] font-semibold">
                  Experienced local guides for safe pacing and navigation
                </span>
              </li>
            </ul>
          </div>
