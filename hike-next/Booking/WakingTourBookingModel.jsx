    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-xl w-[95%] md:w-[600px] p-6 relative animate-fadeIn max-h-[90vh] overflow-y-auto">
                ...
                <button
                    onClick={onClose}
                    className="absolute top-3 right-3 p-1.5 rounded-full hover:bg-gray-100 disabled:opacity-50"
                ...
                <div className="inline-flex mb-6 bg-[#FAD4C3] rounded-lg p-1">
                    <button
                        ...
                        className={`px-4 py-1.5 transition-all font-['Nunito_Sans'] font-semibold text-[12px] leading-[24px] ${tab === "fixed"
                    ...
                    <button
                        ...
                        className={`px-4 py-1.5 transition-all font-['Nunito_Sans'] font-semibold text-[12px] leading-[24px] ${tab === "flexible"
                            ? "bg-[#C56441] text-white rounded-lg"
                            : "text-[#EA8E6C] bg-transparent"
                            }`}
                        disabled={isSubmitting}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            >
                                ...
                                <option value="Ilkley Moor">Ilkley Moor</option>

                                <option value="skipton">Skipton</option>
                                <option value="bolton-abbey">Bolton Abbey</option>
                            ...
                            {selectedLocation === "other" && (
                                <div className="mt-3">
                                    <label className="font-['Nunito_Sans'] font-medium text-[14px] leading-[20px] text-[#5A5A5A]">
                                        Please specify your hike route *
                                    </label>
                                    <input
                                        type="text"
                                        value={customLocation}
                                        onChange={handleCustomLocationChange}
                                        placeholder="please enter your hike route"
                                        className="w-full mt-1 p-2 rounded-full bg-[#FFF5F1] outline-none font-['Nunito_Sans'] font-medium text-[14px] leading-[20px] text-[#5A5A5A] placeholder-gray-400"
